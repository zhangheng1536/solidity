...
IF "%VERSION%"=="2015" (
    ...
    IF EXIST "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Redist\MSVC\*\x86\Microsoft.VC141.CRT\" (
        set "DLLS=C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Redist\MSVC\*\x86\Microsoft.VC141.CRT\msvc*.dll"
		) ELSE (
        set "DLLS=C:\Program Files (x86)\Microsoft Visual Studio\2017\BuildTools\VC\Redist\MSVC\*\x86\Microsoft.VC141.CRT\msvc*.dll"
    )
)
